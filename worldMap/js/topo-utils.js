        ...
        draw.addPoint = function(data, flag) {
            ...
            for(var i = 0, ilen = data.length; i < ilen; i ++) {
                ...
                if(data[i].type == "MAX") {
                    ...
                    }else if(data[i].name == "新加坡") {
                        var _ptext = world.paper.text(_objp.x,_objp.y + 10, data[i].name).attr({
                           
                            fill:"#ffffff",
                            "font-size":"8px"
                        });
                    }else if(data[i].name == "约翰内斯堡") {
                        var _ptext = world.paper.text(_objp.x,_objp.y + 10, data[i].name).attr({
                           
                            fill:"#ffffff",
                            "font-size":"8px"
                        });
                    }else if(data[i].name == "洛杉矶") {
                        var _ptext = world.paper.text(_objp.x,_objp.y + 10, data[i].name).attr({
                    ...
                    if(flag) {
                        var _textX = _objp.x;
                        var _textY = _objp.y + 10;
                        if(data[i].name == "多伦多") {
                            _textY = _objp.y - 10;
                        }else if(data[i].name == "芝加哥") {
                            _textY = _objp.y - 10;
                        }else if(data[i].name == "西雅图") {
                            _textY = _objp.y - 10;
                        }else if(data[i].name == "吉隆坡") {
                            _textY = _objp.y - 10;
                        }else if(data[i].name == "雅加达") {
                            _textX = _objp.x + 15;
                            _textY = _objp.y - 2;
                        }else if(data[i].name == "曼谷") {
                            _textY = _objp.y - 10;
                        }else if(data[i].name == "斯德哥尔摩") {
                            _textY = _objp.y - 10;
                        }
                        world.paper.text(_textX, _textY, data[i].name).attr({                         
                            fill:"#ffffff",
                            "font-size":"7px"
                        });
                    }
            ...
            for(var i = 0, ilen = data.length; i < ilen; i ++) {
                if(pointMap.get(data[i].aname) && pointMap.get(data[i].bname)) {
                    ...
                    var _tootipArr = data[i].aname + "-" + data[i].bname + "<br>"
                                    ...
                                    + "MAX利用率(入):" + data[i].maxin + "%<br>"
                                    + "MAX利用率(出):" + data[i].maxout + "%<br>"
                                    + "总带宽:" + data[i].dbwinfo;
                    ...
                    var cc = world.paper.circle(0,0,1.3);
                    cc.attr({stroke:"#fff","stroke-opacity":0.4,"stroke-width":4,"fill-opacity":1,fill:"#fefefe"});
                    ...
                    _line.dblclick(
                        function() {
                            ...
                            circuitTable.init();
                            circuitTable.loadData(dataUrl, flag);
