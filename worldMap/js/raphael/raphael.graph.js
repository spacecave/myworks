(function(global) {
    ...
    graphProto.autoSet = function(tox) {
        ...
        if (0 == this.nodes.length) {
            ...
            this.zoom = zoom;
            var viewbox_x = centerPos.x - this.width / this.zoom / 2;
            if(tox) {
                viewbox_x = centerPos.x - this.width / this.zoom / 2 - tox;
            }
            this.setViewBox(
                viewbox_x,
    ...
    graphProto.addNode = function(id, data) {
        ...
        switch (_type) {
            ...
            case 'image':
                ...
                if(_alarmColor){
                    var r = Math.max(_width,_height)/4 * 3;
    ...
    graphProto.tooltip = function(id){
        ...
        function _mousemove(e){
            ...
            if((fx-tip.clientWidth/2)<0){
                ...
                tip.style.top = (fy-tip.clientHeight/2 - 10)+"px";
            }else{
                tip.style.left = (fx-tip.clientWidth/2)+"px";
                tip.style.top = (fy-tip.clientHeight-16)+"px";
            }
        };
