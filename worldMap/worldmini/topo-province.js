            ...
            var drawBezier = function(data) {
                var drawBezierNodes = function(topoDom, opts) {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        if(nodeType == "cloud") {
                            hovert = "<i style='display:block;color:#FFFF00;font-size:11px;line-height:14px;margin-top:6px;'>双击可查看电路列表</i>"; 
                        }
                ...
                var devdbClick = function(ele) {
                    window.open("/portal/monitor-center/device.html?devid=" + ele.deviceid + "&webset=163","_blank");
                }
                var inXdev;
                if(devC) {
                ...
                if(devCloud) {
                    ...
                    var lineDBClick = function(ele) {
                        ...
                        var circuitTable = new CircuitTable("phy-cir-table", "163");
