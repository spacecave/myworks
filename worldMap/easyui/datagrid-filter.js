...
//					var columns = [];
//					
//					if((from == 'city' || from == 'time' || from == 'circuitprop' || from == 'circuitname') 
//							&& (to == 'city' || to == 'time' || to == 'circuitprop' || to == 'circuitname')) {
//						columns = $(target).datagrid('options').frozenColumns;
//					}else if((to != 'city' && to != 'time' && to != 'circuitprop' && to != 'circuitname') 
//							&& (from != 'city' && from != 'time' && from != 'circuitprop' && from != 'circuitname')){
